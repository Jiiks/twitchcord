/*
    TwitchCord version 1.6 by Jiiks
                                ...
                                'var words = ph.split(" "); '                                                                                                   +
                                    'if(words != null) {  '                                                                                                     +
                                        'words.some(function(word) { '                                                                                          +
                                            ...
                                            '} else if(ffz) { '                                                                                                 +
                                                'if(emotesffz.hasOwnProperty(word)) {'  + 'console.log("ffs");'                                                                         +
...
function initCustomCss() {
    execJs('var tcStyle = document.createElement("style"); tcStyle.type = "text/css"; tcStyle.innerHTML = "' +
        ...
        ' #emote-menu { background:#36393E; height:0; width:300px; position:absolute; bottom:45px; right:0; border:1px solid #000; border-radius: 15px 0 0 0; overflow:auto; -webkit-transition: height 1s;}' +
        ...
        ' .emotemenu-open { height:450px !important; }' +
